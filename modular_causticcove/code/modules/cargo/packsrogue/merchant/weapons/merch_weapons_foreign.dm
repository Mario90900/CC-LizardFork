/datum/supply_pack/rogue/merc_weapons/arquebus
	...
	cost = 250
	contains = list(/obj/item/gun/ballistic/revolver/grenadelauncher/blackpowder/arquebus)
...
/datum/supply_pack/rogue/merc_weapons/arquebus_pistol
	...
	contains = list(/obj/item/gun/ballistic/revolver/grenadelauncher/blackpowder/small/arquebus_pistol)
