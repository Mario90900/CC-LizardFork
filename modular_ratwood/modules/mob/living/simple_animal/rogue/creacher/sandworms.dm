...
/mob/living/simple_animal/hostile/retaliate/rogue/sandworm
	...
	icon = 'modular_ratwood/icons/roguetown/mob/monster/sandworm.dmi'
	icon_state = "worm"
	icon_living = "worm"
	icon_dead = "worm_dead"
...
/mob/living/simple_animal/hostile/retaliate/rogue/sandworm/elder/proc/try_slam(atom/target_atom)
	...
	new /obj/effect/temp_visual/rend_warning/sandworm(warn_turf)
