...
/datum/runeritual/summoning/hellhound
	...
	blacklisted = FALSE
	tier = 2
	required_atoms = list(/obj/item/magic/infernal/ash = 3, /obj/item/magic/obsidian = 2)
...
/datum/runeritual/summoning/watcher
	...
	blacklisted = FALSE
	tier = 3
	required_atoms = list(/obj/item/magic/infernal/fang = 2, /obj/item/magic/obsidian = 2)
...
/datum/runeritual/summoning/archfiend
	...
	blacklisted = FALSE
	tier = 4
	required_atoms = list(/obj/item/magic/infernal/core = 1, /obj/item/magic/obsidian = 3)
...
/datum/runeritual/summoning/glimmer
	...
	blacklisted = FALSE
	tier = 2
	required_atoms = list(/obj/item/reagent_containers/food/snacks/grown/manabloom = 2, /obj/item/magic/fae/fairydust = 3)
...
/datum/runeritual/summoning/dryad
	...
	blacklisted = FALSE
	tier = 3
	required_atoms = list(/obj/item/reagent_containers/food/snacks/grown/manabloom = 2, /obj/item/magic/fae/iridescentscale = 2)
...
/datum/runeritual/summoning/sylph
	...
	blacklisted = FALSE
	tier = 4
	required_atoms = list(/obj/item/reagent_containers/food/snacks/grown/manabloom = 1, /obj/item/magic/fae/heartwoodcore = 1)
...
/datum/runeritual/summoning/warden
	...
	blacklisted = FALSE
	tier = 2
	required_atoms = list(/obj/item/magic/elemental/mote = 3, /obj/item/magic/manacrystal = 2)
...
/datum/runeritual/summoning/behemoth
	...
	blacklisted = FALSE
	tier = 3
	required_atoms = list(/obj/item/magic/elemental/shard = 2, /obj/item/magic/manacrystal = 2)
...
/datum/runeritual/summoning/collossus
	...
	blacklisted = FALSE
	tier = 4
	required_atoms = list(/obj/item/magic/elemental/fragment = 1, /obj/item/magic/manacrystal = 1)
