...
/obj/item/rogueweapon/blowrod
	...
	//Caustic Edit - Adding in the Ratwood Pottery and Glassblowing
...
/datum/glass_blow_recipe/statue_any
	name = "glass statue (any design)"
	craftdiff = SKILL_LEVEL_MASTER
	base_time = 42
	result_type = /obj/item/roguestatue/glass
...
/datum/glass_blow_recipe/bottle
	...
	base_time = 28
	result_type = /obj/item/reagent_containers/glass/bottle
	result_count = 2
	recipe_icon = 'icons/roguetown/items/cooking.dmi'
...
/datum/glass_blow_recipe/alch_vial
	...
	craftdiff = SKILL_LEVEL_EXPERT
	base_time = 24
	result_type = /obj/item/reagent_containers/glass/bottle/alchemical
	result_count = 6
	recipe_icon = 'icons/roguetown/misc/alchemy.dmi'
	recipe_icon_state = "vial_bottle"

/datum/glass_blow_recipe/carafe
	name = "glass carafe"
	craftdiff = SKILL_LEVEL_EXPERT
	base_time = 32
	result_type = /obj/item/reagent_containers/glass/carafe/glass
	recipe_icon = 'icons/roguetown/items/cooking.dmi'
	recipe_icon_state = "clear_carafe"

/datum/glass_blow_recipe/cup
	name = "glass cup (x3)"
	craftdiff = SKILL_LEVEL_EXPERT
	base_time = 24
	result_type = /obj/item/reagent_containers/glass/cup/glass/small
	result_count = 3
	recipe_icon = 'modular/Neu_Food/icons/cookware/cup.dmi'
	recipe_icon_state = "glasscup"

/datum/glass_blow_recipe/flute
	name = "glass flute (x3)"
	craftdiff = SKILL_LEVEL_EXPERT
	base_time = 24
	result_type = /obj/item/reagent_containers/glass/cup/glass/flute
	result_count = 3
	recipe_icon = 'modular/Neu_Food/icons/cookware/cup.dmi'
	recipe_icon_state = "glassflute"

/datum/glass_blow_recipe/goblet
	name = "glass goblet (x3)"
	craftdiff = SKILL_LEVEL_EXPERT
	base_time = 24
	result_type = /obj/item/reagent_containers/glass/cup/glass
	result_count = 3
	recipe_icon = 'modular/Neu_Food/icons/cookware/cup.dmi'
	recipe_icon_state = "glassgoblet"
