...
/datum/looping_sound/hurricane
	mid_sounds = 'modular_ratwood/sound/weather/rain/weather_hurricane.ogg'
...
/datum/looping_sound/sandstorm
	mid_sounds = 'modular_ratwood/sound/weather/sand/weather_sandstorm.ogg'
...
/datum/looping_sound/ash
	mid_sounds = 'modular_ratwood/sound/weather/ashstorm/weather_ashstorm.ogg'
	mid_length = 48 SECONDS
	volume = 110
	direct = TRUE

/datum/looping_sound/indoor_ash
	mid_sounds = 'modular_ratwood/sound/weather/ashstorm/weather_ashstorm_indoors.ogg'
