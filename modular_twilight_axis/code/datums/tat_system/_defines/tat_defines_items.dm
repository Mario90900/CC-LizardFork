...
#define TAT_AVAILABLE_ITEMS_LIST \
	...
	/obj/item/gun/ballistic/revolver/grenadelauncher/blackpowder/small/arquebus_pistol = TAT_ITEM_ENTRY("Arquebus Pistol", 7, "weapon", "weapon_supply", TAT_SUPPLY_FIREARMS, "blackpowder"), \
	...
	/obj/item/gun/ballistic/revolver/grenadelauncher/blackpowder/handgonne = TAT_ITEM_ENTRY("Culverin", 7, "weapon", "weapon_supply", TAT_SUPPLY_FIREARMS, "blackpowder"), \
